...
/**
 * Expose socket address info for node.js
 */
WebSocket.prototype.address = function() {
	return this._socket.address();
};
WebSocket.prototype.localAddress = function() {
	return this._socket.address().address;
};
WebSocket.prototype.localPort = function() {
	return this._socket.address().port;
};

WebSocket.prototype.__defineGetter__('remoteAddress', function() {
	return this._socket.remoteAddress;
});
WebSocket.prototype.__defineGetter__('remotePort', function() {
...
function initAsClient(address, protocols, options) {
  ...
  var requestOptions = {
    ...
    createConnection: options.value.createConnection || false,
    headers: {
      'Connection': 'Upgrade',
      'Upgrade': 'websocket',
      'Host': headerHost,
